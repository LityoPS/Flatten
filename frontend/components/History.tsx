  ...
  switch (style) {
    case 'Harsh':
      return (
        <Badge
          variant="outline"
          className="border-0 bg-rose-500/15 text-rose-700 dark:bg-rose-500/10 dark:text-rose-400 text-[10px] md:text-xs px-1.5 md:px-2 py-0.5"
        >
          Harsh
        </Badge>
      );
    ...
    case 'Balanced':
      return (
        <Badge
          variant="outline"
          className="border-0 bg-amber-500/15 text-amber-700 dark:bg-amber-500/10 dark:text-amber-400 text-[10px] md:text-xs px-1.5 md:px-2 py-0.5"
        >
          Balanced
        </Badge>
      );
    ...
    case 'Detailed':
      return (
        <Badge
          variant="outline"
          className="border-0 bg-emerald-500/15 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400 text-[10px] md:text-xs px-1.5 md:px-2 py-0.5"
        >
          Detailed
        </Badge>
      );
