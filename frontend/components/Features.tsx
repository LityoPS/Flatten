            ...
            <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-4">
                {features.map((feature, index) => (
                    <div key={index} className="lg:col-span-1">
                        <div
                            className={`flex flex-col justify-between items-center text-center w-full h-full ${feature.cardBg} px-8 rounded-2xl py-10`}
                        >
                            <div>
                                <h3 className="text-2xl font-semibold mb-3">
                                    <mark
                                        className={`${feature.markText} ${feature.markBg} rounded-md ${feature.markRing} ring-4`}
                                    >
                                        {feature.title}
                                    </mark>
                                </h3>
                            ...
                            <div className="flex justify-center mt-8">{feature.icon}</div>
                        </div>
                    </div>
                ))}
            </div>
